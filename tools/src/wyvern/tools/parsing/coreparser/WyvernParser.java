...
/*** Root production. ***/
  final public AST CompilationUnit() throws ParseException {AST exp;
...
{if ("" != null) return build.unitValue(null);}
  ...
  final public void ImportDecls(LinkedList<AST> decls) throws ParseException {AST exp1;
    AST exp2;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IMPORT:{
      exp1 = ImportDecl();
decls.addLast(exp1);
  ...
  final public AST ImportDecl() throws ParseException {URI uri;
    Token t;
    Token name = null;
    Token meta = null;
    if (jj_2_1(2)) {
...
{if ("" != null) return build.importDecl(uri, loc(t), name, false, (meta != null), true);}
  ...
  final public AST ModuleDecl(LinkedList<AST> imports) throws ParseException {AST exp;
    Token id;
    Type type = null;
    ...
    if (jj_2_2(50)) {
      ...
      jj_consume_token(NEWLINE);
      exp = ModuleBody(imports);
{if ("" != null) return build.moduleDecl(id.image, imports, generics, moduleArgs, exp, type, loc(id), true, true, effects == null ? null : effects.image);}
    } else if (jj_2_3(2)) {
      jj_consume_token(MODULE);
      jj_consume_token(DEF);
      id = jj_consume_token(IDENTIFIER);
      ...
      jj_consume_token(NEWLINE);
      exp = ModuleBody(imports);
{if ("" != null) return build.moduleDecl(id.image, imports, generics, moduleArgs, exp, type, loc(id), true, false, null);}
    } else if (jj_2_4(5)) {
      jj_consume_token(MODULE);
      id = jj_consume_token(IDENTIFIER);
      jj_consume_token(COLON);
      ...
      jj_consume_token(NEWLINE);
      exp = ModuleBody(imports);
{if ("" != null) return build.moduleDecl(id.image, imports, generics, moduleArgs, exp, type, loc(id), isResource, true, effects.image);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case MODULE:{
        jj_consume_token(MODULE);
        ...
        jj_consume_token(NEWLINE);
        exp = ModuleBody(imports);
{if ("" != null) return build.moduleDecl(id.image, imports, generics, moduleArgs, exp, type, loc(id), isResource, false, null);}
        break;
        }
      default:
        jj_la1[13] = jj_gen;
  ...
  final public AST Script(LinkedList<AST> imports, LinkedList<AST> requires) throws ParseException {AST ast;
    AST decl;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VAL:
    case VAR:
...
{if ("" != null) return ast;}
  ...
  final public AST ModuleBody(LinkedList<AST> imports) throws ParseException {AST ast;
    AST decl;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VAL:
    case VAR:
...
{if ("" != null) return build.sequence(decl,ast,true);}
  ...
  final public AST TopLevelCode() throws ParseException {AST ast;
    AST decl;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VAL:
    case VAR:
...
{if ("" != null) return build.sequence(decl,ast,false);}
  ...
  final public AST RequireDecl() throws ParseException {URI uri;
    Token t;
    Token name = null;
...
{if ("" != null) return build.importDecl(uri, loc(t), name, true, false, false);}
  ...
  final public URI Uri() throws ParseException {Token t;
    String scheme = null;
    String s1;
    String s2;
    URI uri;
...
if (scheme == null)
  ...
  final public String Segment() throws ParseException {String s;
    Token t1;
...
{if ("" != null) return s;}
  ...
  final public AST Declaration(boolean inModule) throws ParseException {AST exp;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case DEF:{
      exp = DefDeclaration();
{if ("" != null) return exp;}
...
{if ("" != null) return exp;}
  ...
  final public AST ValDeclaration() throws ParseException {Type type = null;
    Token name;
    AST body;
    List args;
...
{if ("" != null) return build.valDecl(name.image, type, body, loc(name));}
  ...
  final public AST AssertDeclaration() throws ParseException {Token t;
...
{if ("" != null) return build.assertion(description == null ? null : description.image, exp, loc(t));}
  ...
  final public AST TypeAbbrevDeclaration() throws ParseException {Token t = null;
    Type reference = null;
    Token alias = null;
    AST metadata = null;
...
{if ("" != null) return build.typeAbbrevDecl(alias.image, reference, metadata, loc(t));}
  ...
  final public AST EffectDeclaration() throws ParseException {Token name;
    Token effects;
...
{if ("" != null) return build.effectDecl(name.image, effects.image, loc(name));}
  ...
  final public AST ForwardDeclaration() throws ParseException {Type type;
    Token t;
    AST exp;
...
{if ("" != null) return build.forwardDecl(type, exp, loc(t));}
  ...
  final public AST VarDeclType() throws ParseException {Type type;
    Token name;
    List args;
...
{if ("" != null) return build.varDeclType(name.image, type, loc(name));}
  ...
  final public AST DefDeclaration() throws ParseException {Type resultType;
    Token name;
    AST body;
    List args;
    ...
    resultType = Type();
    body = DefBody();
{if ("" != null) return build.defDecl(name.image, resultType, gentypes, args, body, false, loc(name), effects == null ? null : effects.image);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return exp;}
  ...
  final public AST DeclSequence(boolean inModule) throws ParseException {AST decl1;
    AST decl2;
...
{if ("" != null) return decl1;}
  ...
  final public AST VarDeclaration() throws ParseException {Type type;
    Token name;
    AST body;
    List args;
    jj_consume_token(VAR);
...
*/
  final public 
AST TypeDeclaration() throws ParseException {Token name;
    AST body = null;
    AST metadata = null;
...
if (isTagged || (extendedType != null) || (comprisesList != null)) {
  ...
  final public AST TaggedTypeDeclaration() throws ParseException {Token name;
    AST body = null;
    AST metadata = null;
    Type extendedType=null;
    List<Type> comprisesList=null;
...
tagInfo = build.tagInfo(extendedType, comprisesList);
  ...
  final public AST DatatypeDeclaration() throws ParseException {Token name;
    AST body = null;
    AST metadata = null;
    Type extendedType = null;
    List<Type> comprisesList = null;
...
if (isTagged || (extendedType != null) || (comprisesList != null)) {
        ...
        String self = null;
              {if ("" != null) return build.datatypeDecl(name.image, gentypes, body, tagInfo, metadata, loc(name), isResource, self);}
    throw new Error("Missing return statement in function");
  }

  final public AST DeclTypes() throws ParseException {AST decl1;
    AST decl2;
    AST body;
    decl1 = DeclType();
    label_4:
...
{if ("" != null) return decl1;}
  ...
  final public AST DeclType() throws ParseException {AST exp;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case DEF:{
      exp = DefDeclType();
{if ("" != null) return exp;}
...
/*** declaration types ***/
  final public 
List Formals_Lambda() throws ParseException {List args = new LinkedList();
...
args.add(formal);
  ...
  final public Object Formal_Lambda() throws ParseException {Token id;
    Type type = null;
    id = jj_consume_token(IDENTIFIER);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case COLON:{
...
{if ("" != null) return build.formalArg(id.image, type);}
  ...
  final public Object Formal_Lambda_NoEqArrow() throws ParseException {Token id;
    Type type = null;
    id = jj_consume_token(IDENTIFIER);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case COLON:{
...
args.add(formal);
  ...
  final public Object Formal() throws ParseException {Token id;
    Type type;
    id = jj_consume_token(IDENTIFIER);
    jj_consume_token(COLON);
    type = Type();
{if ("" != null) return build.formalArg(id.image, type);}
  ...
  final public Token DSLLines() throws ParseException {Token t, t2;
    int beginColumn;
    String content = "";
...
// just comments and whitespace, return null; didn't really find a DSL
  ...
  final public AST ExpressionLine(boolean makeValDecl) throws ParseException {AST exp;
    AST decls = null;
    Token t;
    Token t2 = null;
    Object caseArm;
...
{if ("" != null) return build.match(exp, cases, loc(t));}
  ...
  final public Object CaseArm() throws ParseException {Token id;
    Token t;
    Token dslTok = null;
    AST exp = null;
    Type type = null;
...
{if ("" != null) return build.caseArm(id.image,type,exp,loc(t));}
  ...
  final public AST Expression(ExpFlags flags) throws ParseException {AST exp;
    AST exp2 = null;
    Object formal;
    Token t = null;
    if (jj_2_14(4)) {
...
{if ("" != null) return exp;}
  ...
  final public AST AssignmentExpression(ExpFlags flags) throws ParseException {AST exp;
    AST exp2 = null;
    Object formal;
    Token t = null;
...
if (exp2 != null) {
  ...
  final public AST LambdaFn(ExpFlags flags) throws ParseException {List formals;
    AST body;
    Token t;
...
{if ("" != null) return build.fn(formals, body, loc(t));}
  ...
  final public List<Type> TypeList() throws ParseException {List<Type> types = new LinkedList<Type>();
    Type type;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:
    case LPAREN:
...
{if ("" != null) return types;}
  ...
  final public Type Type() throws ParseException {Type arrowResult = null;
    Token ar=null;
    Type t;
    Type t2;
...
if (arrowResult == null) {
  ...
  final public Type NonArrowType() throws ParseException {Token id = null;
    Token id2 = null;
    AST exp = null;
...
System.out.println("WyvernParser.jj: PlaceHolder Type Detected at " + loc(id) + " with name = " + id.image); // debugger print
  ...
  final public AST BooleanRelationalExpression(ExpFlags flags) throws ParseException {AST exp;
    AST exp2 = null;
    Token t;
...
{if ("" != null) return exp;}
  ...
  final public AST RelationalExpression(ExpFlags flags) throws ParseException {AST exp;
    AST exp2 = null;
    Token t;
...
{if ("" != null) return exp;}
  ...
  final public AST AdditiveExpression(ExpFlags flags) throws ParseException {AST exp;
    AST exp2 = null;
    Token t;
...
{if ("" != null) return exp;}
  ...
  final public AST MultiplicativeExpression(ExpFlags flags) throws ParseException {AST exp;
    AST exp2 = null;
    Token t;
...
{if ("" != null) return exp;}
  ...
  final public AST UnaryExpression(ExpFlags flags) throws ParseException {AST exp;
    Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PLUS:{
...
{if ("" != null) return exp;}
  ...
  final public AST PrimaryExpression(ExpFlags flags) throws ParseException {AST exp;
    Token t;
    Token selfName = null;
...
String self = (selfName == null) ? null : selfName.image;
  ...
  final public void Extension(LinkedList<String> names, LinkedList<AST> args) throws ParseException {AST exp;
    Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
      t = jj_consume_token(IDENTIFIER);
...
if (!names.isEmpty())
  ...
  final public AST PrimaryPrefix(ExpFlags flags) throws ParseException {AST exp;
    Token t;
    boolean recur = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STRING_LITERAL:
...
recur = true;
      t = jj_consume_token(IDENTIFIER);
{if ("" != null) return build.var(t.image, loc(t));}
      break;
      }
    case LPAREN:{
      jj_consume_token(LPAREN);
...
exp = build.dsl(loc(t));
  ...
  final public AST Literal() throws ParseException {AST exp;
    Token lit;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case FLOATING_POINT_LITERAL:{
...
exp = build.dsl(loc(lit));
  ...
  final public AST PrimarySuffix(AST lhs, ExpFlags flags, boolean recur) throws ParseException {List<AST> rhs;
    Token t;
    List<GenericArgument> generics = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case DOT:{
...
{if ("" != null) return expList;}
  ...
  final public List<AST> ExpressionList() throws ParseException {AST exp;
...
{if ("" != null) return expList;}
  ...
  final public AST Instantiation() throws ParseException {URI uri;
    Token name;
    List<AST> args;
...
{if ("" != null) return gens;}
  ...
  final public List GenericList() throws ParseException {LinkedList<GenericArgument> genList = new LinkedList<GenericArgument>();
...
genList.addFirst(t1);
  ...
  final public GenericArgument GenericArgument() throws ParseException {Type type;
    Token effect;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:
    case LPAREN:
...
{if ("" != null) return gens;}
  ...
  final public List GenericListDecl() throws ParseException {LinkedList<GenericParameter> genList = new LinkedList<GenericParameter>();
  ...
  private boolean jj_3R_172()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x6ce6a7e,0x80000,0x1000,0x1000000,0x1000,0x1000000,0x80000,0x0,0x0,0x0,0x0,0x0,0x0,0x4000,0x6ce2a7e,0x6ce227e,0x6ce2a7e,0x1000000,0x0,0x0,0x200002e,0x4842200,0x0,0x0,0x80000000,0x0,0x0,0x0,0x40000000,0x6c6227e,0x400000,0x10000,0x8000,0x0,0x1000,0x400000,0x10000,0x8000,0x0,0x1000,0x80000000,0x400000,0x0,0x0,0x1000,0x242005e,0x200000e,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x200000,0x4042000,0x200000,0x44042000,0x4002000,0x0,0x84002000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4002000,0x4000000,0x0,0x0,0x0,0x4002000,0x0,0x4000000,0x4000000,0x0,0x0,0x0,0x4002000,0x0,0x0,0x4002000,0x0,0x0,0x0,0x0,0x2000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0xec,0x0,0x0,0x0,0x0,0x0,0x0,0x8000000,0xc,0x8000000,0x100000,0xc,0x100000,0x0,0xec,0xec,0xec,0x0,0x200,0x80000,0x0,0xec,0x100000,0x800,0x0,0x7c4,0x8000000,0x0,0x800,0xec,0x0,0x0,0x0,0x8,0x0,0x0,0x0,0x0,0x8,0x0,0x0,0x0,0x8000000,0x8,0x0,0x4,0x4,0x0,0x7c4,0x8000000,0x0,0x800,0x8000000,0x8,0x4,0xc,0x10000,0x100000,0x100000,0x4,0x10000,0x2,0x2,0x2,0x4,0xec,0x4,0xec,0xec,0x800,0xec,0x10000,0xc,0x100,0x60000,0x0,0x60000,0x80000,0x8000000,0x80000,0xc,0x80000000,0x80000000,0x600f000,0x600f000,0xc0,0xc0,0x700,0x700,0xec,0x0,0x8080008,0x4,0x8,0x2c,0x4,0x0,0x2c,0x0,0x8000000,0x8080008,0xec,0x10000,0x10000,0xec,0x7c0,0x10000,0xc,0x10000,0x4,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x1fe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x2,0x0,0x0,0x1fe,0x1fe,0x1fe,0x0,0x0,0x0,0x0,0x1fe,0x0,0x0,0x0,0x0,0x0,0x100,0x0,0x1fe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x100,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1fe,0x0,0x1fe,0x1fe,0x0,0x1fe,0x0,0x2,0x0,0x0,0x100,0x0,0x0,0x0,0x0,0x2,0x1,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x1fe,0x0,0x0,0x100,0x0,0x1fc,0x100,0x0,0x1fc,0x1fc,0x0,0x0,0x1fe,0x0,0x0,0x1fe,0x0,0x0,0x102,0x0,0x0,};
   }
