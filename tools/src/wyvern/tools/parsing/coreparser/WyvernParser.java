...
/** Root production. */
  final public AST CompilationUnit() throws ParseException {LinkedList<AST> imports= new LinkedList<AST>(); AST exp; LinkedList<AST> requires = new LinkedList<AST>();
    ...
    case MODULE:{
      /*ImportDecls(imports)*/ exp = ModuleDecl(imports);
{if ("" != null) return exp;}
      break;
      }
    case VAL:
...
decls.addLast(exp1);
  ...
  final public AST ModuleDecl(LinkedList<AST> imports) throws ParseException {AST exp; Token id; Type type = null; List<GenericParameter> generics = null; List moduleArgs = new LinkedList(); boolean isResource = false; Token effects = null;
    if (jj_2_1(50)) {
...
if (effects == null) {
           {if ("" != null) return build.moduleDecl(id.image, imports, generics, moduleArgs, exp, type, loc(id), true, true, null);}
        }
        {if ("" != null) return build.moduleDecl(id.image, imports, generics, moduleArgs, exp, type, loc(id), true, true, effects.image);}
    } else if (jj_2_2(2)) {
      jj_consume_token(MODULE);
      jj_consume_token(DEF);
      id = jj_consume_token(IDENTIFIER);
...
tagInfo = build.tagInfo(extendedType, comprisesList);
  ...
  final public AST DatatypeDeclaration() throws ParseException {Token name; AST body = null; AST metadata = null; Type extendedType=null; List<Type> comprisesList=null; boolean isTagged = false;
  Token selfName = null; List<GenericParameter> gentypes = null;
  Object tagInfo = null; boolean isResource = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case RESOURCE:{
      jj_consume_token(RESOURCE);
...
if (isTagged || (extendedType != null) || (comprisesList != null)) {
  ...
  final public AST DeclTypes() throws ParseException {AST decl1; AST decl2; AST body;
    decl1 = DeclType();
    label_4:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
if (arrowResult == null) {
  ...
  final public Type NonArrowType() throws ParseException {Token id = null; Token id2 = null; AST exp = null; List<GenericArgument> generics = null; Type t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LPAREN:{
      jj_consume_token(LPAREN);
      t = Type();
...
if (!names.isEmpty())
  ...
  final public AST PrimaryPrefix(ExpFlags flags) throws ParseException {AST exp; Token t; boolean recur = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STRING_LITERAL:
    case CHARACTER_LITERAL:
    case FLOATING_POINT_LITERAL:
  ...
  private boolean jj_3R_48()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x367357e,0x40000,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x367157e,0x367117e,0x367157e,0x800000,0x800,0x800000,0x800,0x800000,0x40000,0x0,0x0,0x363117e,0x100002e,0x2421100,0x0,0x0,0x0,0x0,0x0,0x40000000,0x200000,0x8000,0x4000,0x0,0x800,0x200000,0x8000,0x4000,0x0,0x800,0x40000000,0x200000,0x0,0x0,0x800,0x121005e,0x100000e,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,0x40000000,0x40000000,0x100000,0x2021000,0x100000,0x22021000,0x2001000,0x0,0x42001000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2001000,0x2000000,0x0,0x0,0x0,0x2001000,0x0,0x2000000,0x2000000,0x0,0x0,0x0,0x2001000,0x0,0x0,0x2001000,0x0,0x0,0x0,0x0,0x1000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x76,0x0,0x4000000,0x6,0x4000000,0x80000,0x6,0x80000,0x0,0x76,0x76,0x76,0x0,0x0,0x0,0x0,0x0,0x0,0x100,0x40000,0x76,0x0,0x76,0x3e2,0x4000000,0x0,0x80000,0x400,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x4000000,0x4,0x0,0x2,0x2,0x0,0x3e2,0x4000000,0x0,0x400,0x4000000,0x4,0x2,0x6,0x8000,0x80000,0x80000,0x2,0x8000,0x400,0x1,0x1,0x1,0x2,0x76,0x2,0x76,0x76,0x400,0x76,0x8000,0x6,0x80,0x30000,0x0,0x30000,0x40000,0x4000000,0x6,0xc0000000,0xc0000000,0x3007800,0x3007800,0x60,0x60,0x380,0x380,0x76,0x0,0x4040004,0x2,0x4,0x16,0x2,0x0,0x16,0x0,0x4000000,0x4040004,0x76,0x8000,0x8000,0x76,0x3e0,0x8000,0x6,0x8000,0x2,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0xff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xff,0xff,0xff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xff,0x0,0xff,0x0,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xff,0x0,0xff,0xff,0x0,0xff,0x0,0x0,0x0,0x0,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xff,0x0,0x0,0x80,0x0,0xfe,0x80,0x0,0xfe,0xfe,0x0,0x0,0xff,0x0,0x0,0xff,0x0,0x0,0x80,0x0,0x0,};
   }
